...
autocmd BufNewFile,BufReadPost * if &filetype == "yaml" | set softtabstop=2 | set indentkeys-=0# | set expandtab | endif
autocmd BufRead,BufNewFile *.sls setlocal filetype=jinja.yaml
